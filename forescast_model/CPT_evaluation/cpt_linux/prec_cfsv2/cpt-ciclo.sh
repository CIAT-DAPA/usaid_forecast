...
workspace="/home/aesquivel/CPT_prec/15.3.7"
conf_file=$1
echo $conf_file
for localidad in `ls /home/aesquivel/CPT_prec/15.3.7/predictando`
do
...
5       #Save cross-validated predictions
...
25	#Save deterministic forecasts
$Deter_forecasts
26	#Save deterministic forecast ensembles
$Deter_forecast_ensembles
27	#Save deterministic prediction error variances
$Deter_Errors
## Confidence limits
28	#Save prediction limits
$PredictionLimits

##  Predictors
29  # Predictor Time Scores
